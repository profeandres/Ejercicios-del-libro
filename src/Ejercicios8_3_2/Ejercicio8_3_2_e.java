...
cuál de los dos tiene más dígitos impares
*/
public class Ejercicio8_3_2_e {
    ...
    public static void main(String[] args) {
        ...
        if (cifra1>cifra2){
            System.out.println("El número "+num1+" tiene más cifras impares que "+num2);
        }else if(cifra1==cifra2){
            System.out.println("El número "+num1+" tiene las mismas cifras impares que "+num2);
        }else{
            System.out.println("El número "+num2+" tiene más cifras impares que "+num1);
        }
    }
}
